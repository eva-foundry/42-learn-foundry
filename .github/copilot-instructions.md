# GitHub Copilot Instructions -- 42-learn-foundry

**Template Version**: 3.2.0
**Last Updated**: February 25, 2026 10:14 ET
**Project**: 42-learn-foundry -- {PROJECT_ONE_LINE_DESCRIPTION}
**Path**: `C:\AICOE\eva-foundry\42-learn-foundry\`
**Stack**: {PROJECT_STACK}
...
This file is the copilot-instructions for **42-learn-foundry** (42-learn-foundry).
...
Once this file has been loaded, the active project is locked to **42-learn-foundry** for the entire session.
...
**Name**: Learn Foundry
**Folder**: `C:\AICOE\eva-foundry\42-learn-foundry`
**ADO Epic**: [TODO]
**37-data-model record**: `GET /model/projects/42-learn-foundry`
**Maturity**: poc
**Phase**: Phase 1 -- Learning Sandbox
...
Invoke-RestMethod "$base/model/endpoints/" |
  Where-Object { $_.implemented_in -like '*42-learn-foundry*' } |
